...
public class AuthorityResourcesDaoImpl extends BaseSessionDaoSupport implements AuthorityResourcesDao{
	...
	@Override
	public Integer insertBatch(List<AuthorityResourcesPO> listPo){
		Integer count=0;
		for(AuthorityResourcesPO authorityResourcesPo : listPo){
			this.insert(authorityResourcesPo);
			count++;
		}
		return count;
	}
	...
	@Override
	public List<AuthorityResourcesPO> selectPageListByCondition(AuthorityResourcesPO authorityResourcesPo, int pageNum, int limit) {
