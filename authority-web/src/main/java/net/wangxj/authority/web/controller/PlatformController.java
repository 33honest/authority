...
public class PlatformController extends AbstractController<PlatformDTO>{
	...
	public JSONObject platformList(@RequestBody String jsonStr){
		...
		//条件查询
		String pageResult = JerseyClient.rest(RequestMethod.GET,BASE_URL + "/platforms",null, null, queryParamMap, "");
	...
	public String addPlatform(String platform_name , String platform_domain , String platform_sign, Integer platform_status){
		...
		return  JerseyClient.rest(RequestMethod.POST,BASE_URL + "/platforms", null, null, null, JSONObject.toJSONString(platform));
	}
	...
	public String editPlatform(String platform_name , String platform_domain ,
		...
		return JerseyClient.rest(RequestMethod.PUT,BASE_URL + "", pathList, null, null, JSONObject.toJSONString(platform));
	}
	...
	public String deleteByBatch(@RequestBody List<String> uuidList){
		...
		return JerseyClient.rest(RequestMethod.DELETE,BASE_URL + "/platforms", null, null, queryParam, null);
	}
	...
	public String isRepeatField(String platform_uuid ,String platform_name, String platform_sign, String platform_domain){
		...
		String isRepeatResult = JerseyClient.rest(RequestMethod.GET,BASE_URL + "" , pathList , null,queryParam , null);
