...
public class AuthorityRoleController extends AbstractController<AuthorityRoleDTO>{
	...
	public JSONObject roleList(@RequestBody String jsonStr){
		...
		String pageRes = JerseyClient.rest(RequestMethod.GET,BASE_URL + "/roles", null, null, paramMap, null);
	...
	public String addRole(String role_name , Integer role_status, String role_platform_uuid){
		...
		return JerseyClient.rest(RequestMethod.POST,BASE_URL + "", pathList, null, null, JSONObject.toJSONString(roleDto));
	}
	...
	public String editRole(String role_name , Integer role_status, String role_platform_uuid,String role_uuid){
		...
		return JerseyClient.rest(RequestMethod.PUT,BASE_URL + "", pathList, null, null, JSONObject.toJSONString(roleDto));
	}
	...
	public String deleteByBatch(@RequestBody List<String> uuidList){
		...
		return JerseyClient.rest(RequestMethod.DELETE,BASE_URL + "/roles", null, null, queryParam, null);
	}
