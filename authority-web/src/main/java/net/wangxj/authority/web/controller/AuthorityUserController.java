...
public class AuthorityUserController extends AbstractController<AuthorityUserDTO>{
	...
	public JSONObject userList(@RequestBody String jsonStr){
	    ...
	    String pageResultStr = JerseyClient.rest(RequestMethod.GET,BASE_URL + "/users", null, null, paramMap, null);
	...
	public String addUser(String user_login_name ,String user_email,String user_login_password,
		...
		return  JerseyClient.rest(RequestMethod.POST,BASE_URL + "/users", null, null, null, JSONObject.toJSONString(userDto));
	}
	...
	public String editUser(String user_login_name ,String user_email,String user_login_password,
		...
		return JerseyClient.rest(RequestMethod.PUT,BASE_URL + "", pathList, null, null, JSONObject.toJSONString(userDto));
	}
	...
	public String deleteByBatch(@RequestBody List<String> uuidList){
		...
		return JerseyClient.rest(RequestMethod.DELETE,BASE_URL + "/users", null, null, queryParam, null);
	}
	...
	public String isRepeatField(String user_uuid , String user_email , String user_phone , String user_login_name){
		...
		String isRepeatresult = JerseyClient.rest(RequestMethod.GET,BASE_URL + "", pathList, null, paramMap, null);
