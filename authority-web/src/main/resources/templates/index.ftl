    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">authority</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">authority
                        </div>
                    </li>
                    ...
                    <li>
                        <a class="J_menuItem" href="platform/">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="platform/" frameborder="0" data-id="platform" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
